...
const handler = async (m, {conn, text, groupMetadata}) => {
  ...
  const fakegif = {key: {participant: `0@s.whatsapp.net`, ...('925029406-9250294060@g.us' ? {remoteJid: '925029406-925029406@g.us'} : {})}, message: {'videoMessage': {'title': '❄*𝙵𝚞𝚛𝚒𝚘𝚞𝚜 - 𝙱𝚘𝚝*❄', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '❄*𝙵𝚞𝚛𝚒𝚘𝚞𝚜 - 𝙱𝚘𝚝*❄', 'jpegThumbnail': false}}};
